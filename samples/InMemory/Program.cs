...
namespace Sample
{
    public class Program
    {
        ...
        {
            // The DB root is essential for the projections to work
            // due to implementation details of the InMemoryDatabase.
            var dbRoot = new InMemoryDatabaseRoot();
            var dbContext = CreateDbContext(dbRoot);
        ...
        private static SampleDbContext CreateDbContext(InMemoryDatabaseRoot dbRoot)
        {
            var ctxOptionsBuilder = new DbContextOptionsBuilder<SampleDbContext>()
                .UseInMemoryDatabase("sample", dbRoot)
